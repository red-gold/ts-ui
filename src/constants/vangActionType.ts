export enum VangActionType {
    ...
    CHAT_REQUEST_ACTIVE_PEER_ROOM = 'CHAT_REQUEST_ACTIVE_PEER_ROOM',
    CLOSE_ACTIVE_ROOM = 'CLOSE_ACTIVE_ROOM',
    CLOSE_ALL_ACTIVE_ROOM = 'CLOSE_ALL_ACTIVE_ROOM',
    ADD_ROOM = 'ADD_ROOM',
    ADD_ROOMS = 'ADD_ROOMS',
    ACTIVE_PEER_CHAT_ROOM = 'ACTIVE_PEER_CHAT_ROOM',
    CHAT_SET_PEER_ACTIVE = 'CHAT_SET_PEER_ACTIVE',
    ...
    SET_ROOM_LAST_MESSAGE = 'SET_ROOM_LAST_MESSAGE',
