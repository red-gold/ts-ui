...
export class RecentChatItemComponent extends Component<IRecentChatItemProps, IRecentChatItemState> {
    ...
    handleSeenRecentChat = (event: any) => {
        ...
        if (id && seenRecentChat && closeRecentChat && goTo) {
            if (!isSeen) {
                seenRecentChat(id);
            }
            closeRecentChat();
    ...
    handleSetCurrentChat() {
        ...
        if (setCurrentChat && closeRecentChat) {
     ...
     */
    render() {
        const { description, fullName, avatar, isSeen, goTo, closeRecentChat, followerId, classes } = this.props;
        if (!goTo || !closeRecentChat) {
            return <div />;
        }
        return (
            <ListItem
                ...
                onClick={this.handleSetCurrentChat}
...
export default connect<{}, {}, any, any>(
    mapStateToProps,
    mapDispatchToProps,
)(withStyles(recentChatItemStyles)(RecentChatItemComponent as any));
