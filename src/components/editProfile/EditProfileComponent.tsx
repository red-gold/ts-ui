...
export class EditProfileComponent extends Component<
    IEditProfileComponentProps & WithTranslation,
...
> {
     ...
     *
     */
    constructor(props: IEditProfileComponentProps & WithTranslation) {
        super(props);
        const { info } = props;
        const userInfo = throwNoValue(info, 'info');
        // Defaul state
        this.state = {
            /**
             ...
             */
            tagLineInput: userInfo.get('tagLine', ''),
            /**
             * User full name input value
             */
            fullNameInput: userInfo.get('fullName', ''),
            /**
             ...
             * User banner address
             */
            banner: userInfo.get('banner', config.settings.defaultProfileCover),
            /**
             * User avatar address
             */
             ...
             */
            defaultBirthday:
                props.info && props.info.get('birthday') ? moment.unix(props.info.get('birthday')).toDate() : '',
            /**
             * Seleted birth day
             */
            selectedBirthday: 0,
             ...
             */
            permission:
                props.info && props.info.get('permission') ? props.info.get('permission') : UserPermissionType.Public,
            /**
             * User facebook id
             */
                        ...
                        <div className="profile__edit">
                            ...
                            <div className="left">
                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                    ...
                                    <UserAvatarComponent
                                        fullName={this.props.info ? this.props.info.get('fullName') : ''}
                        ...
                        <Paper style={this.styles.paper} elevation={1}>
                            ...
                            <div className={classes.box}>
                                <FormControl fullWidth aria-describedby="fullNameInputError">
                                    ...
                                    />
                                    <FormHelperText id="fullNameInputError">
                            ...
                            <div className={classes.box}>
                                <FormControl fullWidth aria-describedby="tagLineInputError">
                                    ...
                                    />
                                    <FormHelperText id="tagLineInputError">
                                        {this.state.fullNameInputError}
                                    </FormHelperText>
                                </FormControl>
                            </div>
                ...
                {this.state.openBanner && (
                    ...
                    >
                        <DialogTitle className={classes.dialogTitle}>
                            <AppDialogTitle
                                title={t('profile.chooseBanerDialogTitle')}
...
const translateWrapper = withTranslation('translations')(EditProfileComponent);
