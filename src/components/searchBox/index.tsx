                ...
                <Input
                    ...
                    startAdornment={
                        <InputAdornment position="end">
                            <SearchIcon className={classes.searchIcon} onMouseDown={this.handleMouseDown} />
                        </InputAdornment>
                    }
                />
...
const translateWrapper = withTranslation('translations')(SearchBoxComponent);

export default connect<{}, {}, any, any>(
    mapStateToProps,
    mapDispatchToProps,
)(withStyles(searchBoxStyles as any, { withTheme: true })(translateWrapper as any) as any);
