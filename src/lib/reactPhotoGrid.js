            ...
            if (
                ...
                var indexForBestMaxImage = _imagesToShow.reduce(function (result, image, index) {
                    if (
                        ...
                        image[winner] / image[loser] > _imagesToShow[result][winner] / _imagesToShow[result][loser]
                    ) {
                        return index;
                    }
                    return result;
                ...
                case 1:
                    ...
                    if (images[0].width > images[0].height) {
                        styles = [
                            {
                                ...
                                height:
                                    (Math.min(this.state.containerWidth, images[0].width) * images[0].height) /
                                        images[0].width -
                                    margin,
                                margin: margin,
                            },
                        ...
                        styles = [
                            {
                                width:
                                    (Math.min(this.state.containerHeight, images[0].height) * images[0].width) /
                                        images[0].height -
                                    margin,
