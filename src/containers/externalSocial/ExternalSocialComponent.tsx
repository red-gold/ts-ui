...
export class ExternalSocialComponent extends Component<IExternalSocialProps & WithTranslation, IExternalSocialState> {
     ...
     *
     */
    constructor(props: IExternalSocialProps & WithTranslation) {
        super(props);
        ...
        return (
            <>
                ...
                <Timeline
                    ...
                    onLoad={() => log.info('Timeline is loaded!')}
                />
            </>
        );
    };
    ...
    instagramElement = () => {
        ...
        return (
            <>
                ...
                {instagramPosts.count() > 0 ? (
                    <PostStreamComponent displayWriting={false} posts={instagramPosts} />
                ) : (
                    loginElement
                )}
            </>
        ...
        return (
            <Paper className={classes.noConfigPaper}>
                <Typography className={classes.needConfigText} variant="subtitle1">
                    ...
                    {t('externalSocial.needConfig', { social, userId: currentUser ? currentUser.userId : 0 })}
                </Typography>
            </Paper>
        );
    };
    ...
    render() {
        ...
        return <div className={classes.root}>{this.loadRootElemtn()}</div>;
    }
}
...
const translateWrapper = withTranslation('translations')(ExternalSocialComponent);

export default connect<{}, {}, any, any>(
    mapStateToProps,
    mapDispatchToProps,
)(withStyles(externalSocialStyles as any)(translateWrapper as any));
