...
export class EmailVerificationComponent extends Component<
    IEmailVerificationProps & WithTranslation,
...
> {
    ...
    handleVerifyCode = () => {
        ...
        this._authorizeService
            .confirmVerificationEmail(code, verifyId)
            .then((user: LoginUser) => {
                if (login && home) {
                    login(user);
                    home();
                            ...
                            <div className={classes.boxRoot}>
                                ...
                                <div
                                    className={classnames({
                                        [classes.noDisplay]: step !== EmailVerificationStepType.EnterPhoneNumber,
                                    })}
                                >
                                    <br />
                                    <br />
                                    ...
                                    <div className="settings__button-box">
                                        ...
                                        <div className={classes.wrapper}>
                                            <Button
                                                ...
                                                disabled={!isCaptchaSuccess || loading}
                                ...
                                <div
                                    className={classnames({
                                        [classes.noDisplay]: step !== EmailVerificationStepType.VerificationCode,
                                    })}
                                >
                                    <FormControl
