...
const createFetchStreamRequest = (userId: string) => {
    ...
    return new ServerRequestModel(ServerRequestType.StreamGetPosts, requestId, '', ServerRequestStatusType.Sent);
};
...
const createSearchPostRequest = (userId: string) => {
    ...
    return new ServerRequestModel(ServerRequestType.SearchPosts, requestId, '', ServerRequestStatusType.Sent);
};
...
const createFetchPostUserRequest = (userId: string) => {
    ...
    return new ServerRequestModel(ServerRequestType.ProfileGetPosts, requestId, '', ServerRequestStatusType.Sent);
};
...
const createFetchAlbumRequest = (userId: string) => {
    ...
    return new ServerRequestModel(ServerRequestType.ProfileGetAlbums, requestId, '', ServerRequestStatusType.Sent);
};
