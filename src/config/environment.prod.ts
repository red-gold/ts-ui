...
export const environment = {
    ...
    settings: {
        ...
        supportEmail: import.meta.env.VITE_APP_EMAIL_SUPPORT,
    ...
    gateway: {
        base_route_api: import.meta.env.VITE_APP_BASE_ROUTE_API,
        gateway_url: import.meta.env.VITE_APP_GATEWAY,
        gateway_uri: `${import.meta.env.VITE_APP_GATEWAY}${import.meta.env.VITE_APP_BASE_ROUTE_API}`,
        auth_web_uri: `${import.meta.env.VITE_APP_AUTH_WEB_URI}`,
        github_oauth_url: `${import.meta.env.VITE_APP_GITHUB_OAUTH_URL}`,
